...
export default function Home() {
  ...
  const links = [
    { title: "Home", icon: <IconHome className="h-full w-full" />, href: "https://www.devnation.org.in/" },
    { title: "Our Services", icon: <IconTerminal2 className="h-full w-full" />, href: "https://www.devnation.org.in/" },
